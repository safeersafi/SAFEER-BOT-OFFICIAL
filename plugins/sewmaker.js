...
const Lang = Language.getString('sewmaker');
   ...
   Asena.addCommand({pattern: 'bot2maker', fromMe: false, desc: Lang.SEWTXTTOIMG_DESC}, (async (message, match) => {    

    await message.sendMessage('```✪BOT 2 MAKER✪```\n\n*✪TEXT TO IMAGE✪*\n\n\nNEW COMMAND \n\n\n♻️Usage: *.ninjalogo*\n✪Desc: Enters the text as the caption for a ninja themed logo.\n📀 Example : *.ninjalogo Safeer*\n\n♻️Usage: *.sparkling*\n✪Desc: Converts the text into a sparkling themed image\nYou must enter the heading and subheading seperated by *;* in order!\n📀 Example : *.sparkling Safeer;Safi*\n\n♻️Usage: *.shadow*\n✪Desc: Converts the text into shadow themed image.\n📀 Example : *.Shadow Safeer*\n\n♻️Usage: *.phub*\n✪Desc: Converts the text into phub logo.\n📀 Example : *.phub Safeer/Safi*\n\n♻️Usage: *.lovemsg*\n✪Desc: It Sends love message style image of the text provided.\n📀 Example : *.lovemsg Safeer*\n\n♻️Usage: *.grass*\n✪Desc: It Sends a grass image of the text provided.\n📀 Example : *.grass Safeer*\n\n♻️Usage: *.blood*\n✪Desc: It Sends a blood image of the text provided.\n📀 Example : *.blood Safeer*\n\n♻️Usage: *.romance*\n✪Desc: It Sends a green image with love shapes of the text provided.\n📀 Example : *.romance Safeer*\n\n♻️Usage: *.candlemug*\n✪Desc: It Sends a mug image of the text provided.\n📀 Example : *.candlemug Safeer*\n\n♻️Usage: *.snow*\n✪Desc: It Sends a snow image of the text provided.\n📀 Example : *.snow Safeer*\n\n♻️Usage: *.cloud*\n✪Desc: It Sends a sky image of the text provided\n📀 Example : *.cloud Safeer*\n\n♻️Usage: *.flower*\n✪Desc: It Sends a flower image of the text provided\n📀 Example : *.flower Safeer*\n\n♻️Usage: *.burn*\n✪Desc: It Sends a half burned paper image of the text provided\n📀 Example : *.burn Safeer*\n\n♻️Usage: *.candy*\n✪Desc: It Sends a candy image of the text provided\n📀 Example : *.candy Safeer*\n\n♻️Usage: *.wood*\n✪Desc: It Sends a wood carved image of the text provided.\n📀 Example : *.wood Safeer*\n\n♻️Usage: *.latte*\n✪Desc: It put the text as latte art within a coffee cup.\n📀 Example : *.latte Safeer*\n\n♻️Usage: *.8bit*\n✪Desc: Converts the text into an 8bit style image.\nYou must enter the heading and subheading seperated by *;* in order!\n📀 Example : *. Safeer ; Safi*\n\n♻️Usage: *.glue*\n✪Desc: it makes 3D Glue text\n📀 Example : *.glue Safeer*\n\n♻️Usage: *.harrypotter*\n✪Desc: Converts the text into a harrypotter themed image.\n📀 Example : *.harrypotter Safeer*\n\n♻️Usage: *.watercolour*\n✪Desc: Converts the text into a watercolour themed image.\n📀 Example : *.watercolor Safeer*\n\n♻️Usage: *.neonlight*\n✪Desc: Converts the text into a neonlight themed image.\n📀 Example : *.neonlight Safeer*\n\n♻️Usage: *.3dtext*\n✪Desc: Converts the provided text into a 3D style image.\n📀 Example : *.3dtext Safeer*\n\n♻️Usage: *.glitch*\n✪Desc: It Sends a glitch style image of the text provided\nYou must enter the heading and subheading seperated by *;* in order!.\n📀 Example : *.glitch Safeer;Safi*\n\n♻️Usage: *.galaxy*\n✪Desc: it makes metal galaxy text\n📀 Example : *.galaxy Safeer/Safi*\n\n♻️Usage: *.skull*\n✪Desc: it makes skull logo\n📀 Example : *.skull Safeer*\n\n♻️Usage: *.robot*\n✪Desc: it makes Robot logo\n📀 Example : *.robot Safeer*\n\n♻️Usage: *.toxic*\n✪Desc: it makes Toxic logo\n📀 Example : *.toxic Safeer*\n\n♻️Usage: *orangeglass*\n✪Desc: it makes gradient text\n📀 Example : *.orangeglass Safeer*\n\n♻️Usage: *.sandwriting*\n✪Desc: It Sends a sand image of the text provided.\n📀 Example : *.sandwriting Safeer*\n\n♻️Usage: *.underwater*\n✪Desc: It Sends a ocean image of the text provided\n📀 Example : *.underwater Safeer*\n\n\n\This command below is currently unavailable and will be enabled in the future\n\n\n\n\n♻️Usage: *.gradient*\n✪Desc: it makes gradient text\n\n♻️Usage: *.vintage*\n✪Desc: it makes Vintage  text\n\n♻️Usage: *.balloon*\n✪Desc: it makes Balloon text\n\n♻️Usage: *.1917*\n✪Desc: it makes 1917 font text\n\n♻️Usage: *.holo*\n✪Desc: it makes 3D holographic  text\n\n♻️Usage: *.silver*\n✪Desc: it makes silver metal text\n\n♻️Usage: *.blue*\n✪Desc: it makes Blue metal text\n\n♻️Usage: *.fabric*\n✪Desc: it makes Fabric text\n\n♻️Usage: *.avengers*\n✪Desc: it makes avengers text\nYou must enter the heading and subheading seperated by */* in order!\n\n♻️Usage: *.logomarvel*\n✪Desc: it makes Marvel logo text\nYou must enter the heading and subheading seperated by */* in order!\n\n♻️Usage: *.silvermetal*\n✪Desc: it makes silver metal  text\n\n♻️Usage: *.rosegold*\n✪Desc: it makes Rose gold text\n\n♻️Usage: *.metalgold*\n✪Desc:it makes metal gold  text\n\n♻️Usage: *.lion*\n✪Desc: it makes Lion logo\n\n♻️Usage: *.joker*\n✪Desc: it makes joker logo text\n\n♻️Usage: *.leaves*\n✪Desc: it makes leaves text\n\n♻️Usage: *rainbow*\n✪Desc: it makes gradient text\n\n♻️Usage: *.luxury*\n✪Desc: it makes luxury text\n\n♻️Usage: *.pubg*\n✪Desc: It Sends Pubg Logo with text\nYou must enter the heading and subheading seperated by */* in order!\n\n♻️Usage: *.marvel*\n✪Desc: It Sends marvel logo typeYou must enter the heading and subheading seperated by */* in order!\n\n♻️Usage: *.google*\n✪Desc: It Sends a google suggest\n\n♻️Usage: *.fire*\n✪Desc: It Sends a fire logo\n\n♻️Usage: *.banner*\n✪Desc: It Sends a banner text\n\n♻️Usage: *.coffeecup*\n✪Desc: It Send a coffeecup image\n\n♻️Usage: *.battle*\n✪Desc: It Sends a battle logoYou must enter the heading and subheading seperated by */* in order!\n\n♻️Usage: *.silk* \n✪Desc: It Sends a silk text  \n\n♻️Usage: *.ph* \n✪Desc: It Sends a blackish orange coloured image of the text provided. You must enter the heading and subheading seperated by */* in order!.  \n\n♻️Usage: *.blackpink* \n✪Desc: It Sends a blackish pink image of the text provided.  \n\n♻️Usage: *.bpink* \n✪Desc:converts the given text into blackpink logo.');
...
Asena.addCommand({ pattern: 'sewttp ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Asena.addCommand({ pattern: 'sewattp ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
...
Asena.addCommand({ pattern: 'sewsttp ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
 ...
 Asena.addCommand({ pattern: 'sewanimesay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'sewchangesay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Asena.addCommand({ pattern: 'sewtrumpsay ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
...
Asena.addCommand({pattern: 'underwater ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*Made By Safeer*'})
