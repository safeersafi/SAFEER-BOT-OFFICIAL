...
if (config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'song ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,Lang.EDUKUNUNDEDA_CHAKARE,MessageType.text);
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                reply = await message.client.sendMessage(message.jid,Lang.NAN ON_AANE,MessageType.text);
