...
const array = ['Missing','mind','morning','set','Criminal','Entry','Thyr','Admin','kundan','ay','muthe','mass','its me','Cr7','Tone','Messi','item','Annan','Azaru','Ada','Hi','Hii','sad','Myre','Mrng','Da','WELCOME','Left','Link','Ok','Aliya', 'Pova','Myr','setta','range','Mood','love','Ninde','you','poli','Happy','girl','Andi','chadhi','Aara','Bot','But y','Haha','Ithentha','Ivanetha','Safeer','Sorry','Thug','Power','Lala','Thamasha','La ba','Poweresh','Fek','Messi','Boss','Avastha','Aarulle','Ayn','Aysheri','Sed','Helo' ]
array.map( async (a) => {
