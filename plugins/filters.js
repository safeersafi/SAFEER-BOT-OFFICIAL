...
const array = ['Azaru','Ada','Hi','Hii','sad','Myre','Alive','Mrng','Da','WELCOME','Left','Link','Ok','Aliya','alive','Amal','help','Pova','Myr','Setta','range','Mood','love','Ninde','you','poli','Happy','girl','Andi','chadhi']
array.map( async (a) => {
