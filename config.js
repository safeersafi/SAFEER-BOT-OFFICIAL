...
module.exports = {
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? '•-SAFEER BOT OFFICIAL-•' : process.env.BOT_NAME,PLKBGM: process.env.CHANGE_BGM_TO === undefined ? 'one' : process.env.CHANGE_BGM_TO,
